...
> 💡 **Core Technology: JPyRust**
> 이 프로젝트의 핵심 AI 추론 파이프라인에는 **본 프로젝트의 저자가 직접 설계하고 개발한** 독자적인 Native IPC 라이브러리인 **[JPyRust](https://github.com/farmer0010/JPyRust)**가 탑재되어 있습니다. 이를 통해 Java와 Python 간의 무거운 네트워크 소켓 병목을 완전히 제거하고, C++ Shared Memory 기반의 초고속 제로 카피(Zero-Copy) 데이터 전송을 실현해 냈습니다.
